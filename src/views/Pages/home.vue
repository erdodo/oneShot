              ...
              <div class="tg-latestresult">
                <div class="row">
                  ...
                  <div class="col-md-4 col-sm-12 col-xs-12">
                    <div
                      id="tg-matchscrollbar"
                      class="tg-matchscrollbar tg-allmatchstatus"
                    >
                            ...
                            <div class="tg-match">
                              <div class="tg-box">
                                <strong class="tg-teamlogo">
                                  <img
                                    :src="
                                      baseUrl + '_assets/images/team-logo/logo-s-01.png'
                                    "
                                    alt="image description"
                                  />
                                </strong>
                        ...
                        <div class="swiper-slide">
                          <div class="tg-match">
                            <div class="tg-matchdetail">
                              <div class="tg-box">
                                <strong class="tg-teamlogo">
                                  <img
                                    :src="
                                      baseUrl + '_assets/images/team-logo/logo-l-02.png'
                                    "
                                    alt="image description"
                                  />
                                </strong>
                            ...
                            <div class="tg-matchhover">
                              <address>
                                Jan16, 2017 15:30 PM Soccer Stadium, Dubai
                              </address>
                              <div class="tg-btnbox">
      ...
      <section class="tg-videobox tg-haslayout">
        <figure>
          ...
          <figcaption>
            <a
              class="tg-playbtn"
              href="https://youtu.be/iC9CpnSj-MU?iframe=true"
            ...
            <div class="row">
              <div class="tg-pointstablewrapper">
                ...
                <div class="col-sm-4 col-xs-12 hidden-xs">
                  <figure>
                    <img
                      :src="baseUrl + '_assets/images/img-03.png'"
                      alt="image description"
                    />
                  </figure>
                </div>
                  ...
                  <div class="col-sm-6 col-xs-12">
                    <article class="tg-post">
                      <figure class="tg-postimg">
                        <a href="#">
                          <img
                            :src="baseUrl + '_assets/images/blog/img-01.jpg'"
                            alt="image description"
                          />
                        </a>
                        <figcaption>
                      ...
                      <div class="tg-posttitle">
                        <h3>
                          <a href="#">dipisicing elit sed do eiusmod tempor indunt</a>
                        </h3>
                      </div>
                      <div class="tg-description">
                        <p>
                          Consectetur adipisicing elit sed do eiusmod temport incididunt
                          utia labore et dolore magna aliqua enima ad minim veniam
                          quistrud on ullamco laboris nisiut aliquip exea commodo
                          consequat.
                        </p>
                      </div>
                  ...
                  <div class="col-sm-6 col-xs-12">
                    <article class="tg-post">
                      <figure class="tg-postimg">
                        <a href="#">
                          <img
                            :src="baseUrl + '_assets/images/blog/img-02.jpg'"
                            alt="image description"
                          />
                        </a>
                        <figcaption>
...
<script>
import sliderBox from "../Wrapper/slider-box.vue";
import Maclar from "../../components/maclar.vue";
import PuanTablosu from "../../components/puanTablosu.vue";
export default {
  components: { sliderBox, Maclar, PuanTablosu },
  data() {
    return {
