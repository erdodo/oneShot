							...
							<div class="tg-aboutussection">
								<div class="row">
									<div class="col-md-6 col-sm-12 col-xs-12">
										<figure>
											<img :src="baseUrl+'_assets/images/img-01.jpg'" alt="image description">
										</figure>
									</div>
									<div class="col-md-6 col-sm-12 col-xs-12">
						...
						<div class="row">
							<div class="tg-upcomingmatch-counter">
								<div class="col-md-4 col-sm-4 col-xs-12 hidden-xs">
									<figure>
										<img :src="baseUrl+'_assets/images/img-02.png'" alt="image description">
									</figure>
								</div>
													...
													<div class="tg-box">
														...
														<div class="tg-teamscore">
															<strong class="tg-team-logo">
																<a href="#">
																	<img :src="baseUrl+'_assets/images/team-logo/logo-01.png'" alt="image description">
																</a>
															</strong>
														...
														<div class="tg-teamscore">
															<strong class="tg-team-logo">
																<a href="#">
																	<img :src="baseUrl+'_assets/images/team-logo/logo-02.png'" alt="image description">
																</a>
															</strong>
															<div class="tg-team-nameplusstatus">
														...
														<div class="tg-match">
															<div class="tg-box">
																<strong class="tg-teamlogo">
																	<img :src="baseUrl+'_assets/images/team-logo/logo-s-01.png'" alt="image description">
																</strong>
																<h4>win</h4>
															</div>
															<div class="tg-box">
												...
												<div class="swiper-slide">
													<div class="tg-match">
														<div class="tg-matchdetail">
															<div class="tg-box">
																<strong class="tg-teamlogo">
																	<img :src="baseUrl+'_assets/images/team-logo/logo-l-02.png'" alt="image description">
																</strong>
																<h3>Gladiators</h3>
															</div>
															<div class="tg-box">
										...
										<div id="tg-playerscrollbar" class="tg-players tg-playerscrollbar">
											<div class="tg-player">
												...
												<div class="col-sm-6 col-xs-6">
													<figure>
														<a href="#">
															<img :src="baseUrl+'_assets/images/player/img-01.png'" alt="image description">
														</a>
													</figure>
												</div>
											</div>
											<div class="tg-player">
												...
												<div class="col-sm-6 col-xs-6">
													<figure>
														<a href="#">
															<img :src="baseUrl+'_assets/images/player/img-02.png'" alt="image description">
														</a>
													</figure>
												</div>
											</div>
											<div class="tg-player">
												...
												<div class="col-sm-6 col-xs-6">
													<figure>
														<a href="#">
															<img :src="baseUrl+'_assets/images/player/img-03.png'" alt="image description">
														</a>
													</figure>
												</div>
											</div>
						...
						<div class="row">
							<div class="tg-pointstablewrapper">
								...
								<div class="col-sm-4 col-xs-12 hidden-xs">
									<figure>
										<img :src="baseUrl+'_assets/images/img-03.png'" alt="image description">
									</figure>
								</div>
							</div>
						</div>
								...
								<div class="row">
									<div class="col-sm-6 col-xs-12">
										<article class="tg-post">
											<figure class="tg-postimg">
												<a href="#">
													<img :src="baseUrl+'_assets/images/blog/img-01.jpg'" alt="image description">
												</a>
												<figcaption>
									...
									<div class="col-sm-6 col-xs-12">
										<article class="tg-post">
											<figure class="tg-postimg">
												<a href="#">
													<img :src="baseUrl+'_assets/images/blog/img-02.jpg'" alt="image description">
												</a>
												<figcaption>
													<ul class="tg-postmetadata">
														<li><a href="#">by admin</a></li>
