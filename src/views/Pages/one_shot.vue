  ...
  <div>
    ...
    <main id="tg-main" class="tg-main tg-haslayout">
              ...
              <div class="tg-aboutussection">
                <div class="row">
                  <div class="col-md-6 col-sm-12 col-xs-12">
                    <figure>
                      <img
                        :src="baseUrl + '_assets/images/img-01.jpg'"
                  ...
                  <div class="col-md-6 col-sm-12 col-xs-12">
                    <div class="tg-contentbox">
                      <div class="tg-section-heading">
                        <h2>
                          consectetur adipisicing elit sed do eiusmid tempor incididunt
                          labore
                        </h2>
                      </div>
                      <div class="tg-description">
                        <p>
                          ...
                          utia labore et dolore magna aliqua enim ad minim veniam quistrud
                          on ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis
                          aute irure dolor in reprehenderit in voluptate velit esse cillum
                          doloreeu fugiat nulla pariatur cepteur sint occaecat.
                        </p>
                      </div>
                      <div class="tg-btnbox">
                ...
                <div class="row">
                  <div class="col-md-3 col-sm-6 col-xs-6">
                    <article class="tg-post">
                      <figure class="tg-postimg">
                        <a
                          class="tg-playbtn"
                          href="https://youtu.be/a0ksVaLlaIw?iframe=true"
                          data-rel="prettyPhoto[iframe]"
                        ></a>
                        <img
                          :src="baseUrl + '_assets/images/history-section/img-01.jpg'"
                          alt="image description"
                        />
                        <figcaption>
                      ...
                      <div class="tg-description">
                        <p>
                          Consectetur adipisicing elit sed do eiusmod temport incididunt
                          utiaie et dolore magna aliqua enimatam veniam quistrud
                        </p>
                      </div>
                    </article>
                  </div>
                  <div class="col-md-3 col-sm-6 col-xs-6">
                    <article class="tg-post">
                      <figure class="tg-postimg">
                        <img
                          :src="baseUrl + '_assets/images/history-section/img-02.jpg'"
                          alt="image description"
                        />
                        <figcaption>
                          <ul class="tg-postmetadata">
                  ...
                  <div class="col-md-3 col-sm-6 col-xs-6">
                    <article class="tg-post">
                      <figure class="tg-postimg">
                        <img
                          :src="baseUrl + '_assets/images/history-section/img-03.jpg'"
                          alt="image description"
                        />
                        <figcaption>
                          <ul class="tg-postmetadata">
                  ...
                  <div class="col-md-3 col-sm-6 col-xs-6">
                    <article class="tg-post">
                      <figure class="tg-postimg">
                        <img
                          :src="baseUrl + '_assets/images/history-section/img-04.jpg'"
                          alt="image description"
                        />
                        <figcaption>
                          <ul class="tg-postmetadata">
      ...
      <section class="tg-videobox tg-haslayout">
        <figure>
          <img :src="baseUrl + '_assets/images/bg-video.jpg'" alt="image description" />
          <figcaption>
            <a
              class="tg-playbtn"
              href="https://youtu.be/a0ksVaLlaIw?iframe=true"
                      ...
                      <div class="tg-player">
                        <div class="col-sm-6 col-xs-6 pull-right">
                          <div class="tg-playcontent">
                            ...
                            <div class="tg-description">
                              <p>
                                Incididunt utia labore et dolore siti magna aliqua adinim
                                lipat
                              </p>
                            </div>
                        ...
                        <div class="col-sm-6 col-xs-6">
                          <figure>
                            <a href="#">
                              <img
                                :src="baseUrl + '_assets/images/player/img-01.png'"
                                alt="image description"
                              />
                            </a>
                          </figure>
                      ...
                      <div class="tg-player">
                        ...
                        <div class="col-sm-6 col-xs-6">
                          <figure>
                            <a href="#">
                              <img
                                :src="baseUrl + '_assets/images/player/img-02.png'"
                                alt="image description"
                              />
                            </a>
                          </figure>
                      ...
                      <div class="tg-player">
                        ...
                        <div class="col-sm-6 col-xs-6">
                          <figure>
                            <a href="#">
                              <img
                                :src="baseUrl + '_assets/images/player/img-03.png'"
                                alt="image description"
                              />
                            </a>
                          </figure>
            ...
            <div id="tg-testimonial-slider" class="tg-testimonial-slider tg-haslayout">
              <div class="swiper-wrapper">
                <div class="swiper-slide">
                  <figure>
                    <img
                      :src="baseUrl + '_assets/images/trophy.png'"
                      alt="image description"
                    />
                  </figure>
                  <div class="tg-contentbox">
                    ...
                    <div class="tg-description">
                      <p>
                        ...
                        labore et dolorena aliqua enim ad minim veniam quis nostrud
                        exercitation ullamco laboris nisi ut aliquip ex ea commodo
                        consequat aute irure dolor in reprehenderit in voluptate velit
                        esse cillum dolore eu fugiat nulla pariatur sint occaecat.
                      </p>
                    </div>
                    <ul class="tg-socialicons">
                      <li>
              ...
              <div class="tg-latestresult tg-oursponsers">
                <div class="row">
                  <div class="col-md-5 col-sm-12 col-xs-12">
                    <div class="tg-contentbox">
                      <div class="tg-section-heading">
                        <h2>consectetur adipisicing elit sedia tempor labore</h2>
                      </div>
                      <div class="tg-description">
                        <p>
                          Consectetur adipisicing elit sed do eiusmod temport incididunt
                          utia labore et dolore magna aliqua enima ad minim veniam
                          quistrud on ullamco laboris nisiut aliquip ex ea commodo
                          consequat.
                        </p>
                      </div>
                      <div class="tg-btnbox">
                            ...
                            <div class="tg-matchdetail">
                              <div class="tg-box">
                                <strong class="tg-teamlogo">
                                  <img
                                    :src="baseUrl + '_assets/images/sponser/img-01.png'"
                                    alt="image description"
                                  />
                                </strong>
                              </div>
                          ...
                          <div class="tg-match">
                            <div class="tg-matchdetail">
                              <div class="tg-box">
                                <strong class="tg-teamlogo">
                                  <img
                                    :src="baseUrl + '_assets/images/sponser/img-02.png'"
                                    alt="image description"
                                  />
                                </strong>
                              </div>
                          ...
                          <div class="tg-match">
                            <div class="tg-matchdetail">
                              <div class="tg-box">
                                <strong class="tg-teamlogo">
                                  <img
                                    :src="baseUrl + '_assets/images/sponser/img-03.png'"
                                    alt="image description"
                                  />
                                </strong>
                              </div>
