<template>
	<div>
				...
				<div class="">
					<div class="row">
						<div class="tg-colhalf pull-right">
							<nav class="tg-addnav">
								<ul>
									<li><a href="javascript()" data-toggle="modal" data-target="#tg-login">Giriş</a>
									</li>
									<li><a href="javascript()" data-toggle="modal" data-target="#tg-register">Üye Ol</a>
									</li>
									<li>
										<div class="tg-cart">
											...
											<div class="tg-cartcontent dropdown-menu" aria-labelledby="tg-cartdropdown">
												<ul>
													<li>
														<figure>
															<a href="#">
																<img :src="baseUrl+'_assets/images/thumbnails/img-01.jpg'"
													...
													<li>
														<figure>
															<a href="#">
																<img :src="baseUrl+'_assets/images/thumbnails/img-02.jpg'"
																	alt="image description">
															</a>
														</figure>
														<div class="tg-product-detail">
													...
													<li>
														<figure>
															<a href="#">
																<img :src="baseUrl+'_assets/images/thumbnails/img-03.jpg'"
																	alt="image description">
															</a>
														</figure>
														<div class="tg-product-detail">
						...
						<nav id="tg-nav" class="tg-nav brand-center">
							<div class="navbar-header">
								...
								<strong class="tg-logo">
									<a href="/"><img :src="baseUrl+'_assets/images/logo.png'"
										...
										<li>
											...
											<ul class="tg-dropdown-menu">
												<li v-for="t in turnuva_kategorileri" :key="t">
													<router-link :to="'/turnuvalar/'+t.id"> {{t.name_basic}}
													</router-link>
												</li>
											</ul>
										</li>
		...
		<div class="mobile-header-collapse d-flex d-md-none">
			...
			<button type="button" class="tg-btn px-4 m-4" style="height:min-content" @click="mobileMenu=!mobileMenu">
				<i class="fa fa-bars"></i>
			</button>
			<div class=" mobile-menu" v-if="mobileMenu==true">
				<div class="w-100 d-flex justify-content-end px-5 cursor-pointer"> <h3 class="text-danger" @click="mobileMenu=false">X</h3> </div>
				...
				<div  v-for="t in turnuva_kategorileri" :key="t"  class="mobile-link" @click="mobileMenu=false">
...
<script>
	...
	export default {
		...
		methods: {
			getTurnuvalar() {
				axios.post('public/tables/turnuva_kategorileri', {
