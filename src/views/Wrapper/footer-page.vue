									...
									<div class="tg-toprated">
										<ul>
											<li>
												<figure>
													<a href="#">
														<img :src="baseUrl+'_assets/images/thumbnails/img-04.jpg'" alt="image description">
													</a>
												</figure>
											...
											<li>
												<figure>
													<a href="#">
														<img :src="baseUrl+'_assets/images/thumbnails/img-05.jpg'" alt="image description">
													</a>
												</figure>
												<div class="tg-productcontent">
													<h4><a href="#">Smooth 3-Stripes Scarf</a></h4><span class="tg-stars"><span></span></span>
											...
											<li>
												<figure>
													<a href="#">
														<img :src="baseUrl+'_assets/images/thumbnails/img-06.jpg'" alt="image description">
													</a>
												</figure>
												<div class="tg-productcontent">
													<h4><a href="#">Smooth 3-Stripes Scarf</a></h4><span class="tg-stars"><span></span></span>
											...
											<li>
												<figure>
													<a href="#">
														<img :src="baseUrl+'_assets/images/thumbnails/img-07.jpg'" alt="image description">
													</a>
												</figure>
												<div class="tg-productcontent">
													<h4><a href="#">Smooth 3-Stripes Scarf</a></h4><span class="tg-stars"><span></span></span>
								...
								<div class="tg-footercol">
									<div class="tg-haslayout">
										<strong class="tg-logo">
											<a href="#">
												<img :src="baseUrl+'_assets/images/logo2.png'" alt="image description">
											</a>
										</strong>
									</div>
									<div class="tg-description">
