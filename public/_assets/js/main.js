...
$(document).ready(function () {
	...
	function matchCounter() {
		var launch = new Date('2022', '08', '14', '11', '15');
		var days = $('.tg-days');
		var hours = $('.tg-hours');
	...
	/*------------------------------------------
			ALL MATCHS SLIDER
	------------------------------------------*/
	var mainswiper = new Swiper('#tg-upcomingmatch-slider1', {
		direction: 'vertical',
		slidesPerView: 3,
		spaceBetween: 10,
		mousewheelControl: true,
	...
	var mainswiper = new Swiper('#tg-upcomingmatch-slider2', {
		direction: 'vertical',
		slidesPerView: 3,
		spaceBetween: 10,
		mousewheelControl: true,
	...
	var mainswiper = new Swiper('#tg-upcomingmatch-slider3', {
		direction: 'vertical',
		slidesPerView: 3,
		spaceBetween: 10,
		mousewheelControl: true,
